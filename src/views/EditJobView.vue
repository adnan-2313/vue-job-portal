...
<template>
  <section class="bg-slate-800">
    <div class="container m-auto max-w-2xl py-24">
      <div
        class="bg-slate-700 text-white px-6 py-8 mb-4 shadow-md rounded-md m-4 md:m-0"
      >
        <form @submit.prevent="handleSubmit">
          ...
          <div class="mb-4">
            ...
            <select
              ...
              id="type"
              name="type"
              class="border bg-slate-700 border-slate-400 rounded w-full py-2 px-3"
              required
            >
          ...
          <div class="mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              class="border border-slate-400 rounded w-full py-2 px-3 mb-2"
          ...
          <div class="mb-4">
            ...
            <textarea
              ...
              id="description"
              name="description"
              class="border border-slate-400 rounded w-full py-2 px-3"
              rows="4"
          ...
          <div>
            <button
              class="bg-slate-500 hover:bg-slate-600 cursor-pointer text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
              type="submit"
            >
              Update Job
            </button>
